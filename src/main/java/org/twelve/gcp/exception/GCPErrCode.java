...
public enum GCPErrCode {
     ...
     */
    UNARY_POSITION_MISMATCH, AMBIGUOUS_RETURN, UNAVAILABLE_THIS, FUNCTION_NOT_FOUND, TYPE_CAST_NEVER_SUCCEED, NOT_BE_ASSIGNEDABLE, OUTLINE_NOT_FOUND, NOT_REFER_ABLE, REFERENCE_MIS_MATCH, NOT_INTEGER;
